...
class ServicePackageItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "service", "service_id", "service_name", "description", "quantity", "unit_price", "discount_amount", "position", "subtotal_amount", "total_amount", "created_at", "updated_at"]
...
class ServicePackageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "subtotal_amount", "discount_amount", "total_amount", "created_at", "updated_at"]
