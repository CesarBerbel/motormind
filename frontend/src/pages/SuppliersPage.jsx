...
function normalizeSupplier(item) {
  return {
    ...
    birth_date: item.birth_date || dateInputValue(),
    email: item.email || "",
...
export default function SuppliersPage() {
  ...
  return <>
    ...
    <Card className="border-0 shadow-sm mb-3"><Card.Body><Row className="g-2"><Col md={9}><SearchAutocompleteInput placeholder="Buscar por nome, razão social, CPF/CNPJ, email, telefone, cidade ou UF" value={search} onChange={setSearch} onSearch={load} suggestions={buildSearchSuggestions(items, ["display_name", "full_name", "name", "last_name", "trade_name", "document", "email", "phone", "secondary_phone", "city", "state"])} /></Col><Col md={3}><Button variant="outline-primary" className="w-100" onClick={load}>Buscar</Button></Col></Row></Card.Body></Card>
